...
namespace fhirCsR4B.Models
{
  ...
  /// </summary>
  [JsonConverter(typeof(fhirCsR4B.Serialization.JsonStreamComponentConverter<PackagedProductDefinitionPackageShelfLifeStorage>))]
  public class PackagedProductDefinitionPackageShelfLifeStorage : BackboneElement,  IFhirJsonSerializable {
    /// <summary>
  ...
  public class PackagedProductDefinitionPackage : BackboneElement,  IFhirJsonSerializable {
    ...
    /// Shelf Life and storage information.
    /// </summary>
    public List<PackagedProductDefinitionPackageShelfLifeStorage> ShelfLifeStorage { get; set; }
    /// <summary>
    ...
    public new void SerializeJson(Utf8JsonWriter writer, JsonSerializerOptions options, bool includeStartObject = true)
    {
      ...
      if ((ShelfLifeStorage != null) && (ShelfLifeStorage.Count != 0))
      {
        ...
        foreach (PackagedProductDefinitionPackageShelfLifeStorage valShelfLifeStorage in ShelfLifeStorage)
        {
    ...
    public new void DeserializeJsonProperty(ref Utf8JsonReader reader, JsonSerializerOptions options, string propertyName)
    {
      switch (propertyName)
      {
        ...
        case "shelfLifeStorage":
          ...
          ShelfLifeStorage = new List<PackagedProductDefinitionPackageShelfLifeStorage>();

          while (reader.TokenType != JsonTokenType.EndArray)
          {
            fhirCsR4B.Models.PackagedProductDefinitionPackageShelfLifeStorage objShelfLifeStorage = new fhirCsR4B.Models.PackagedProductDefinitionPackageShelfLifeStorage();
