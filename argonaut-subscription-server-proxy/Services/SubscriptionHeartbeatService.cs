...
{
    /// <summary>A service for sending subscription heartbeat messages.</summary>
    public class SubscriptionHeartbeatService : IHostedService, IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SubscriptionHeartbeatService"/> class.
        /// </summary>
        public SubscriptionHeartbeatService()
        {
        }
        ...
        private void CheckAndSendHeartbeats(object state)
        {
            ...
            SubscriptionManagerR4.Current.ProcessHeartbeats(currentTicks);
            SubscriptionManagerR5.Current.ProcessHeartbeats(currentTicks);
        }
        ...
        {
            Console.WriteLine("Subscription Heartbeat Service Started.");
