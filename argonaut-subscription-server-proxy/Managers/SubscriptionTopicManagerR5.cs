...
namespace argonaut_subscription_server_proxy.Managers
{
    ...
    public class SubscriptionTopicManagerR5
    {
        /// <summary>The instance for singleton pattern.</summary>
        private static SubscriptionTopicManagerR5 _instance;
        ...
        /// created.
        /// </summary>
        private SubscriptionTopicManagerR5()
        {
...
#pragma warning restore CA1054 // Uri parameters should not be strings
        ...
        private static void CheckOrCreateInstance()
        {
            if (_instance == null)
            {
                _instance = new SubscriptionTopicManagerR5();
            }
        }
    }
}
